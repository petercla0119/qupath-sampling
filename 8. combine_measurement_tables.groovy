// Date: 08/08/2019
	...
	/* Description: This script combines individual .txt files within user selected directory into a .csv file.
	 * Note: User should modify line 13 such that 'STAIN PARAMETERS LASTNAME.txt' is the desired name of file
	*/
